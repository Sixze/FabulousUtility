...
#define FU_ATTRIBUTE_ACCESSORS(AttributeName) \
	...
	{ \
		static const FGameplayAttribute Attribute{FindFieldChecked<FProperty>(StaticClass(), FName{GET_MEMBER_NAME_ANSI_STRING_VIEW_CHECKED(ThisClass, AttributeName)})}; \
		return Attribute; \
	} \
	\
