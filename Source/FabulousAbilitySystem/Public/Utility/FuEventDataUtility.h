...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Fabulous Utility|Event Data Utility", Meta = (ReturnDisplayName = "Event Data"))
	...
	UFUNCTION(BlueprintPure, Category = "Fabulous Utility|Event Data Utility",
