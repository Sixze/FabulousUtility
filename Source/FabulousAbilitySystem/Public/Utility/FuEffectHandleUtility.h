...
public:
	UFUNCTION(BlueprintPure, Category = "Fabulous Utility|Effect Handle Utility", Meta = (ReturnDisplayName = "Value"))
	static bool IsActive(FActiveGameplayEffectHandle EffectHandle);

	UFUNCTION(BlueprintCallable, Category = "Fabulous Utility|Effect Handle Utility",
	...
	UFUNCTION(BlueprintCallable, Category = "Fabulous Utility|Effect Handle Utility", Meta = (ExpandBoolAsExecs = "ReturnValue"))
