...
public:
	UFUNCTION(BlueprintPure, Category = "Fabulous Utility|Gameplay Cue Utility", Meta = (ReturnDisplayName = "Actors"))
	static TArray<AActor*> GetActors(const FGameplayCueParameters& Parameters);

	UFUNCTION(BlueprintCallable, Category = "Fabulous Utility|Gameplay Cue Utility",
